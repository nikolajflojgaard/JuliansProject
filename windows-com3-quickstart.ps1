...
Write-Host 'JuliansProject COM3 quickstart' -ForegroundColor Green
Write-Host 'This script assumes your board is on COM3.' -ForegroundColor Green
...
Write-Step 'Uploading sketch to COM3'
& arduino-cli upload -p COM3 --fqbn arduino:avr:uno $SketchPath | Out-Host

Write-Step 'Starting localhost UI on COM3'
